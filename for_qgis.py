...
try:
    file_name = open("/home/matej/Downloads/map.xml","r")#!!nie sys.argv[]
except:
...
""" 
#!!npotrebujeme vytvarat aplikaciu, ked to v nej spustname
...
"/home/matej/Maps/map_poly.shp", "CP1250", None,"ESRI Shapefile")
if error == QgsVectorFileWriter.NoError:
    print "subor bol vytvoreny"
else:
    print "subor sa nepodarilo vytvori"
